...
//    private $useDescriptionForPropData = true;
    ...
    public function __construct () {
        $this->Logger = new ImarketLogger("/upload/log/UpdatePropertiesWorker_debug/");
...
//        $this->arModels[] = $this->restAPI->GetModels(288527);
    ...
    private function GetCatalogGoods() {
        ...
        $filter = ['IBLOCK_ID' => $this->catalogIblockId, 'SECTION_ID' => 2199 /*, "ID" => 414613*/ /*, "!PROPERTY_IS_UPDATED" => 1*/]; // TODO Удалить после полного обновления
