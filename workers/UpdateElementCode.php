...
class UpdateElementCode {
    ...
    public function __construct () {
        $this->Logger = new ImarketLogger("/upload/log/UpdateElementCode/");
    ...
    public function StartWorker() {
        ...
        $select = ['ID', 'CODE', 'NAME', 'PROPERTY_ARTICLE'];
...
//                $newCode = str_replace('_', '-', $item['CODE']);
                ...
                if (!empty($item['PROPERTY_ARTICLE_VALUE'])) {
                    \CIBlockElement::SetPropertyValuesEx($item["ID"], $this->catalogIblockId, ['CML2_ARTICLE' => $item['PROPERTY_ARTICLE_VALUE']]);
                }
...
(new UpdateElementCode())->StartWorker();