...
class UpdatePriceWorker {
    ...
    public function __construct () {
        $this->Logger = new ImarketLogger("/upload/log/UpdatePriceWorker_debug/");
...
//        $this->UpdateStatus(1);
        ...
        if (!empty($this->arCompletedTasks)) {
            ...
            foreach ($this->arCompletedTasks as $taskId => $arTask) {
                ...
                $this->Logger->log("LOG", print_r($arProfileData, true));
...
//            }
            ...
            foreach ($arCatalogAppModels as $arItem) {
                if (empty($arModel["externalId"])) {
                    ...
                    $this->arCatalogAppModels[$arItem["externalId"]] = $arModel;
                }
            }
        }
