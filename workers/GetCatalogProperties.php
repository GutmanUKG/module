...
class GetCatalogProperties {
    ...
    public function __construct () {
        $this->Logger = new ImarketLogger("/upload/log/GetCatalogProperties/");
    ...
    public function StartWorker() {
        ...
        $i = 0;
        $data = '';
        $sql = "SELECT CODE FROM b_iblock_property WHERE IBLOCK_ID='".$this->catalogIblockId."'";
...
(new GetCatalogProperties())->StartWorker();